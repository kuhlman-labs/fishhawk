...
// placeholder and NO top-level `roles:` map — the approval gates now use
// the forge-neutral `approvals` block. A comment-only / no-op preset
// touch that left the handle or the roles map in place fails here even
// though the scope path was touched.
