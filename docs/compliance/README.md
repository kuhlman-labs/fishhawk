...
| [`prompt-injection-evidence.md`](prompt-injection-evidence.md) | What the #2290 untrusted-issue-body and #3192 verify-output quarantine envelopes are PROVEN to do (offline structural containment across six attack classes and four renders) and what remains UNMEASURED (behavioural resistance and the plan-quality delta — #3187), with the re-run recipe for both live arms (E60.2 / #2291). |
