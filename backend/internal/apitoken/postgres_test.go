...
// startContainer mirrors the helper from postgres_test.go and
// webhook/postgres_test.go. Apitoken is in its own package so we
// re-implement here rather than widening either of those.
