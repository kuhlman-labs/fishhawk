...
| `MaxRevisionBasePlanBytes` | `writeRevisionBase` | 60000 | server-derived STRUCTURED document | whole under cap, structured digest above, loud elision when undecodable | **Safe, with a stated judgement.** 60000 is not a bound that exists — it is chosen ~2.5x above realistic plan size, and exceeding it is no longer silent (#3087). |
