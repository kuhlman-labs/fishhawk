...
## Exported surface: why 283 identifiers, not 3

The package presents **283** exported top-level identifiers, but only the three
above are intended entry points. The other 276 are the tool I/O
