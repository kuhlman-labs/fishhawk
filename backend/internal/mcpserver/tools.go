...
than the eight-value raw stage 'state' the REST API reports, and the mapping
is total: pending, awaiting_host_dispatch, dispatched, awaiting_approval and
awaiting_children all bucket to 'pending'; running maps to 'running'; and
succeeded / failed / cancelled map to themselves. Neither vocabulary is
