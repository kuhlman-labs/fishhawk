...
// Instructions is the server `instructions` field returned on
...
const Instructions = `Fishhawk drives a software change through gated stages. You are the operator: the agent proposes, you decide at each gate.
