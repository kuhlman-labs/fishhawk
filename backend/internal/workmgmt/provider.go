...
// issue label (e.g. "low"/"medium"/"high"), empty when the child carries no
// autonomy label. The campaign engine keys on it to keep a human-led
// (autonomy:low) item out of the autonomously-dispatchable Eligible set
// (#1551).
