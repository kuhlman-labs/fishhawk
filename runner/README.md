...
| present but UNREADABLE (a directory at the path, a permission failure) | `nil` | `counterfactual_report_unreadable`, plus `counterfactual_report_unremovable` if cleanup ALSO failed | REMOVED (recursively), or SURVIVES and is named as such |
